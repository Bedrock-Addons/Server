    ...
    return {
      ...
      template: [
        '<div layout="row" layout-align="{{ clAlign || clAlignModel }}">',
            ...
            '<md-button class="md-icon-button color-white" aria-label="Previous" ng-click="vm.gotoPrev()" ng-show="vm.index - 1 >= 0">'+
              '&#8230;<md-tooltip>Previous</md-tooltip>'+
            '</md-button>',
            
            '<md-button class="md-icon-button color-grey" aria-label="Go to page {{i+1}}" ng-repeat="i in vm.stepInfo"',
