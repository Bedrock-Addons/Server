...
textAngular.directive("textAngular", ["$compile", "$window", "$document", "$rootScope", "$timeout", "taFixChrome", function (t, e, n, a, l, i) {
    ...
    a.textAngularTools = o({
        ...
        h4: {
            display: "<button type='button-ta' ng-click='action()' ng-class='displayActiveToolClass(active)'><b>H4</b></button>",
            action: function () {
        ...
        insertImage: {
            ...
            action: function () {
                var t;
                t = prompt("Enter image URL to insert", "");
                if (t !== "" && t !== null) {
        ...
        embedVideo: {
            ...
            action: function () {
                var t;
                t = prompt(
                    "Enter video URL to embed", "");
                if (t !== "" && t !== null) {
                    var html = "<video style=width:100%;height:500px;background-color:#a6a6a6 frameBorder=0 src=" + t + "></video>";
